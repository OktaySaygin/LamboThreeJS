...
import {Environment, Lightformer, ContactShadows, OrbitControls, KeyboardControls} from '@react-three/drei'
...
export default function App() {
  return (
      <KeyboardControls map={keyboardMap}>
          <Canvas gl={{ logarithmicDepthBuffer: true, antialias: false }} dpr={[1, 1.5]} camera={{ position: [0, 0, 30], fov: 25 }}>
